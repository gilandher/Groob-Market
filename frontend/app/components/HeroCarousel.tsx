...
const SLIDES = [
  {
    ...
    cta2: { label: "💬 WhatsApp", href: "https://wa.me/573001805448" },
  ...
  },
  {
    ...
    bg: "linear-gradient(135deg, #7c1a1a 0%, #dc2626 35%, #ea580c 75%, #fbbf24 100%)",
    accent: "#fde68a",
    stats: [
  ...
  {
    id: "envio",
    badge: "🚚 ENVÍOS A TODO COLOMBIA",
    title: "Comprá desde",
    highlight: "Cualquier Ciudad",
    desc: "Valle de Aburrá recibe hoy. El resto del país en 3 a 5 días hábiles.",
    ...
    stats: [
      ...
      { icon: "📦", text: "Nación 3-5 días" },
      { icon: "🔒", text: "100% seguro" },
    ],
  },
  {
    id: "aliados",
    badge: "💼 SOLUCIÓN PARA NEGOCIOS",
    title: "Groob ERP + Facturación",
    highlight: "POS para Negocios",
    desc: "Digitaliza tu negocio y vende con más control. Inventario, ventas, facturación y pedidos en una sola plataforma. ¡Conéctate con Groob Market!",
    cta: { label: "💼 Ser Aliado", href: "/aliados", style: "white" },
    cta2: { label: "💬 Hablemos", href: "https://wa.me/573001805448?text=Hola%20Groob!%20Me%20interesa%20saber%20m%C3%A1s%20sobre%20el%20ERP%20y%20Facturaci%C3%B3n%20POS%20para%20mi%20negocio%20💼" },
    image: "/slide_erp.png",
    bg: "linear-gradient(135deg, #120e2e 0%, #1e1b4b 50%, #4c1d95 100%)",
    accent: "#10b981",
    stats: [
      { icon: "📊", text: "Inventario & Ventas" },
      { icon: "⚡", text: "Facturación POS" },
      { icon: "🤝", text: "Socio Groob Market" },
    ],
  },
  {
    id: "seguro",
    ...
    bg: "linear-gradient(135deg, #021f24 0%, #0284c7 45%, #10b981 85%, #34d399 100%)",
    accent: "#6ee7b7",
    stats: [
      { icon: "✅", text: "Contraentrega" },
  ...
  },
  {
    ...
    desc: "Compra tus productos favoritos, descubre tiendas y recibe promociones exclusivas desde tu celular.",
    cta: { label: "📱 Próximamente", href: "#", style: "white" },
    cta2: { label: "✨ Conocer más", href: "#" },
    image: "/slide_app.png",
    bg: "linear-gradient(135deg, #1e0b36 0%, #4c1d95 40%, #1d4ed8 75%, #06b6d4 100%)",
    accent: "#c084fc",
    stats: [
      { icon: "🛍️", text: "Compra fácil" },
      { icon: "🎁", text: "Promos exclusivas" },
      { icon: "📲", text: "Disponible en iOS y Android" },
    ],
  },
];
