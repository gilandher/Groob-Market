...
export default function Navbar() {
  ...
  const initials = (user?.name || user?.first_name || user?.email || "")
    .slice(0, 2)
    .toUpperCase();

  const isUrlAvatar = user?.avatar && (user.avatar.startsWith("http://") || user.avatar.startsWith("https://"));
  const isSvgAvatar = user?.avatar && user.avatar.startsWith("avatar_");
    ...
    <>
      ...
      <header style={{ position: "sticky", top: 0, zIndex: 500 }}>
        ...
        <div className="navbar-topbar" style={{
          background: "linear-gradient(90deg, #4f15d4 0%, #4210bd 100%)",
          padding: "8px 20px",
          ...
          <span style={{ display: "flex", alignItems: "center", gap: 6, textShadow: "0 1px 2px rgba(0,0,0,0.15)" }}>
            🚚 ¡Envíos a todo Colombia! 🇨🇴 Contraentrega el mismo día en el Valle de Aburrá
          </span>
          <a href="https://wa.me/573001805448" target="_blank" rel="noreferrer"
            style={{
              color: "#fff",
              textDecoration: "none",
              display: "flex",
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 15px rgba(34, 197, 94, 0.4)";
            }}
            onMouseLeave={e => {
          ...
          >
            ...
            <svg width="14" height="14" viewBox="0 0 24 24" fill="#22c55e" style={{ filter: "drop-shadow(0 1px 1px rgba(0,0,0,0.15))" }}>
            ...
            <span style={{ textShadow: "0 1px 1px rgba(0,0,0,0.1)", display: "flex", gap: 4, alignItems: "center" }}>
              <span style={{ opacity: 0.9, fontWeight: 500 }}>Escríbenos:</span>
              <strong style={{ fontWeight: 800 }}>300 180 5448</strong>
            </span>
          </a>
        </div>
                ...
                {user ? (
                  <button
                    ...
                    style={{
                      ...
                      border: (isSvgAvatar || isUrlAvatar) ? "1.5px solid #6c4dff" : "none",
                      background: (isSvgAvatar || isUrlAvatar) ? "transparent" : "linear-gradient(135deg, #6c4dff, #9b8cff)",
                ...
                {showUserMenu && user && (
                  <div style={{
                    ...
                    <div style={{ padding: "12px 16px 8px", borderBottom: "1px solid #f1f5f9" }}>
                     ...
                     {[
                      { icon: "💼", label: "Panel ADM (Importar)", href: "http://localhost:8000/admin/catalog/product/importar-csv/", isExternal: true },
